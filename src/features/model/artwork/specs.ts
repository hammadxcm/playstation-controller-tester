...
export const SPECS: Record<ArtworkKind, ArtworkSpec> = {
  ...
  dualshock4: {
    ...
    parts: {
      ...
      east: ['Active_Circle'],
      west: ['Active_Square'],
      north: ['Active_Triangle'],
      up: ['Active_DPadTop'],
      down: ['Active_DPadBottom'],
      left: ['Active_DPadLeft'],
      right: ['Active_DPadRight'],
      l1: ['Active_L1'],
      r1: ['Active_R1'],
      l2: ['Active_LT'],
      r2: ['Active_RT'],
      select: ['Active_Share'],
      start: ['Active_Options'],
      home: ['Active_PS'],
      touchpad: ['Active_TouchPad'],
    },
    extra: {},
  ...
  dualsenseEdge: {
    ...
    extra: {
      ...
      fnL: ['Active_LFn'],
      fnR: ['Active_RFn'],
      paddleL: ['Active_LBack'],
      paddleR: ['Active_RBack'],
    },
    sticks: { ls: { cap: 'Active_LS' }, rs: { cap: 'Active_RS' } },
    travel: 62,
