...
export const FLAG0 = { compatVibration: 1 << 0, haptics: 1 << 1, rightTrigger: 1 << 2, leftTrigger: 1 << 3, headphoneVolume: 1 << 4, speakerVolume: 1 << 5, micVolume: 1 << 6, audioControl: 1 << 7 }
